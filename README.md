...
The above command opens up the local server which is accessible thru Postman app or CURL command. Port can be changed in the script and same can be used while quering the model. 
